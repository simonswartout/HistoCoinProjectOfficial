import type { Cc0Verdict } from "./types.js";

const KEYWORDS: Array<{ phrase: string; weight: number }> = [
...
export function assessCc0(text: string, extraEvidence: string[] = []): Cc0Verdict {
